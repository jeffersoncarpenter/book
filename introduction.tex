...
It was eventually developed into a rigorous formal system in its own right, now called ``typed $\lambda$-calculus''; see Church~\cite{Church:1940tu,Church:1941tc} for an early formulation.
